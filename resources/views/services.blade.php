 ...
 <nav class="navbar">
    <div class="container">
      ...
      <nav class="nav-links">
        ...
        <a href="{{ url('/services') }}" class="nav-line active">SERVICES</a>
    ...
    <div class="hero-container">
      <img class="hero-image" src="image/bg1.png" />
      <div class="section-title">SERVICES</div>
      <div class="headline">Kami hadir untuk mendengarkan setiap suara masyarakat, memberikan respon cepat, dan mengambil tindakan nyata atas setiap aduan yang masuk. Dengan komitmen pada pelayanan yang transparan dan bertanggung jawab, kami memastikan setiap laporan ditangani dengan penuh perhatian, akurasi, dan kecepatan, demi menciptakan lingkungan yang lebih baik dan harmonis untuk semua.</div>
    </div>
